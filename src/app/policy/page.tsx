...
export default function Page() {
  return (
    <Container>
      ...
      персональных данных, предпринимаемые ИП Петухов Антон Игоревич (далее —
      ...
      на неприкосновенность частной жизни, личную и семейную тайну. 1.2.
      ...
      получить о посетителях веб-сайта https://Verdera.ru. 2. Основные понятия,
      используемые в Политике 2.1. Автоматизированная обработка персональных
      ...
      сетевому адресу https://Verdera.ru. 2.4. Информационная система
      ...
      технологий и технических средств. 2.5. Обезличивание персональных данных —
      ...
      Пользователю или иному субъекту персональных данных. 2.6. Обработка
      ...
      Пользователю веб-сайта https://Verdera.ru. 2.9. Персональные данные,
      ...
      2.10. Пользователь — любой посетитель веб-сайта https://Verdera.ru. 2.11.
      ...
      и/или материалам, содержащимся на веб-сайте Персональные данные фамилия,
      имя, отчество электронный адрес номера телефонов год, месяц, дата и место
      рождения Правовые основания уставные (учредительные) документы Оператора
      ...
      Отправка информационных писем на адрес электронной почты 7. Условия
      ...
      персональных данных. 7.2. Обработка персональных данных необходима для
      ...
      и других видов обработки персональных данных Безопасность персональных
      ...
      Оператора verdera@internet.ru с пометкой «Актуализация персональных
      данных». 8.4. Срок обработки персональных данных определяется достижением
      ...
      электронный адрес Оператора verdera@internet.ru с пометкой «Отзыв согласия
      на обработку персональных данных». 8.5. Вся информация, которая собирается
      ...
      помощью электронной почты verdera@internet.ru. 12.2. В данном документе
      будут отражены любые изменения политики обработки персональных данных
