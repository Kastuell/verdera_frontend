...
export const CourseIntro = ({ course }: { course: CourseT }) => {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-7 mt-10 xl:mt-20  gap-10">
        <div className="xl:col-span-4 grid grid-cols-1 xl:grid-cols-2 gap-10">
          <div className="xl:border-4 border-primary rounded-2xl xl:p-5">
            <h3 className="text-greenish font-bold text-lg xl:text-3xl">
              {course.description.includes.title}:
            </h3>
            <ul className="flex flex-col justify-between gap-5 xl:gap-0 text-sm h-auto xl:h-[220px] mt-4 xl:list-disc list-inside">
        ...
        <div className="xl:row-span-2 xl:col-span-4 xl:border-4 border-primary rounded-2xl xl:p-5">
          <h3 className="text-greenish font-bold text-lg xl:text-3xl">
